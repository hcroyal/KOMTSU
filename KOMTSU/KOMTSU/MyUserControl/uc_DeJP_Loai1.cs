...
namespace KOMTSU.MyUserControl
{
    ...
    public partial class uc_DeJP_Loai1 : UserControl
    {
        ...
        public void SaveData_Loai1(string idImage)
        {
            ...
            Global.db.Insert_Loai1(idImage, Global.StrBatch, Global.StrUsername, txt_Truong03.Text, txt_Truong04.Text, txt_Truong05.Text,  txt_Truong07.Text, txt_Truong09.Text, txt_Truong10.Text, txt_Truong11.Text, txt_Truong12.Text,Global.LoaiPhieu);
        }
